...
/**
 * Processes the thumbnail generation queue.
...
/**
 * Processes the user email sending queue.
 * @param {Object} job The job object from the queue.
 * @param {Function} done The callback function to signal job completion.
 */
userQueue.process(async (job, done) => {
  ...
  try {
    const mailSubject = 'Welcome to ALX-Files_Manager by samsonoluwatobi';
    const mailContent = [
      '<div>',
      '<h3>Hello {{user.name}},</h3>',
      'Welcome to <a href="https://github.com/samsonoluwatobi/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file management API built with Node.js by ',
      '<a href="https://github.com/samsonoluwatobi">Samson Oluwatobi</a>. ',
